...
static asn_per_constraints_t asn_PER_memb_beta_off_ack_ind_constr_2 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_PdschDedicateConfig_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PdschDedicateConfig, beta_off_ack_ind),
		...
		0,
		{ 0, &asn_PER_memb_beta_off_ack_ind_constr_2,  memb_beta_off_ack_ind_constraint_1 },
...
static const asn_TYPE_tag2member_t asn_MAP_PdschDedicateConfig_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* beta-off-ack-ind */
};
