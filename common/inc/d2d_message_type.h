...
#define  MAC_RRC_BCCH_PARA_CFG_CFM  (RRC_MAC_MESSAGE_BASE + 5)
...
#define  RRC_PHY_CS_REQ             	(RRC_PHY_MESSAGE_BASE + 4)
#define  PHY_RRC_MIB_RPT                (RRC_PHY_MESSAGE_BASE + 5)
#define  RRC_PHY_BCCH_PARA_CFG_REQ  	(RRC_PHY_MESSAGE_BASE + 6)
#define  PHY_RRC_BCCH_PARA_CFG_CFM  	(RRC_PHY_MESSAGE_BASE + 7)
#define  RRC_PHY_CONNECT_SETUP_CFG_REQ  (RRC_PHY_MESSAGE_BASE + 8)
#define  PHY_RRC_CONNECT_SETUP_CFG_CFM  (RRC_PHY_MESSAGE_BASE + 9)
